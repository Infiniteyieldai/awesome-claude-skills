...
- [Skill Installation](./skill-installation/) - Installs skills from this collection into Claude Code by copying the skill directory to `~/.config/claude-code/skills/` or `.agents/skills/` for project-level installation.
